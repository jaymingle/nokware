...
TOPICS: tuple[Topic, ...] = (
    ...
    Topic("roads", Category.CIVIC_SERVICE, "Roads and potholes",
          "Potholes, damaged roads, pavements or bridges, missing road markings.", ("dept-works",)),
    ...
    Topic("public_health", Category.CIVIC_SERVICE, "Public health and hygiene",
          "Unhygienic food vending, mosquito breeding sites, dead animals, environmental health nuisances.",
          ("dept-health",)),
    ...
    Topic("transport", Category.CIVIC_SERVICE, "Transport and traffic",
          "Lorry parks and stations, faulty traffic lights, unauthorised parking, road signs.", ("dept-transport",)),
    ...
    Topic("agriculture", Category.CIVIC_SERVICE, "Animals and urban farming",
          "Stray or roaming livestock, animal rearing in the city, urban farming.", ("dept-agriculture",)),
