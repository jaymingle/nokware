...
import { formatDays, percent, periodLabel } from "@/lib/report/dashboard";
...
function stats(figures: Dashboard): Stat[] {
  ...
  return [
    { value: figures.received.toLocaleString(), label: "reports received", note: periodLabel(figures.months), testId: "dashboard-received" },
    { value: figures.resolved.toLocaleString(), label: "resolved", note: `${percent(figures.resolved, figures.received)} of all reports`, testId: "dashboard-resolved" },
    {
  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="flex flex-wrap items-start gap-5">
        <Panel title="Reports received and resolved" lead={`Monthly, ${periodLabel(figures.months)}. Bars: received. Line: resolved in the month.`} className="flex-[1_1_520px]">
    ...
    <div className="mx-auto flex w-full max-w-[1120px] flex-col gap-8">
      <div className="flex max-w-[62ch] flex-col gap-3">
        ...
        <p className="text-base text-ink-soft">
          ...
          trends only: no individual case, address or reporter appears here. Reports about a person&apos;s safety are
          handled privately and are not counted here at all.
        </p>
      </div>
