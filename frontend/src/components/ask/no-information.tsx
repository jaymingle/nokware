...
export function NoInformation({ testIdPrefix }: { testIdPrefix: string }) {
  return (
    <div className="flex flex-col gap-5 rounded-xl border bg-card p-5" data-testid={`${testIdPrefix}-no-information`}>
      <div className="flex flex-col gap-1.5">
        <h3 className="text-[20px] leading-snug">The Ledger doesn&apos;t hold an answer to this yet</h3>
